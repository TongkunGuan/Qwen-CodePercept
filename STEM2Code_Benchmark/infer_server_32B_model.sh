cd /mnt/cpfs_m6_29eu38p1/Group-m6/guantongkun.gtk/ms-swift-3.9.2
source swift_env/bin/activate
#!/bin/bash

# ==================== 默认可配置参数 ====================
# 这些值将在未通过命令行参数指定时使用
MODEL_PATH="/mnt/cpfs_m6_29eu38p1/Group-m6/guantongkun.gtk/weight/sft/32B_vit_freeze_image_caption_stage1_pami_corrected_corpus_noSystem/v4-20260401-104946/checkpoint-42222"
START_PORT=8000
SERVED_MODEL_NAME="CodePercept-32B-image2caption-pami"
